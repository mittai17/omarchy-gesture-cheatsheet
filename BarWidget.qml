...
// Bar button for the Gesture Cheatsheet, and the host for its popup panel.
// Left click toggles the panel; the button itself is just a label, since the
// cheat sheet lives in the panel.
BarWidget {
  id: root
